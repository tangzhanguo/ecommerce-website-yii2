...
<?php $this->beginBlock('scriptBlock'); ?>
  <!-- BEGIN PAGE PLUGINS -->
    <script src="assets/global/plugins/jquery.parallax-1.1.3.js" type="text/javascript"></script>
    <script src="assets/global/plugins/jquery.localscroll-1.2.7-min.js" type="text/javascript"></script>
    <script src="assets/global/plugins/jquery.scrollTo-1.4.2-min.js" type="text/javascript"></script>
    <script src="assets/global/plugins/bxslider/jquery.bxslider.min.js" type="text/javascript"></script>
  <!-- END PAGE PLUGINS -->
